...
//Guardar Encuestas Vivien 
  ...
  $('#ev_guardar').click(function(e) {
   ...
   if (isEmpty(datos_v.E1P1)) {
       return M.toast({ html: 'Pregunta #1 vacío, por favor complete todos los campos',  classes: 'rounded' });
   } else if (isEmpty(datos_v.E1P1)) {
       return M.toast({ html: 'Pregunta #2 vacío, por favor complete el campo', classes: 'rounded' });
   } else if (isEmpty(datos_v.E1P2)) {
       return M.toast({ html: 'Pregunta #3 vacío, por favor complete el campo', classes: 'rounded' });
