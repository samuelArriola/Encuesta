<?php
   ...
   include('../../CONFIG/conexion.php');  
    ...
    $query="SELECT * FROM hogar WHERE  id_vivienda = '$id_vivienda' ORDER BY create_at DESC LIMIT 60" ;

    if (isset($_POST['buscar'])) {
     $buscar_u = mysqli_real_Escape_string ($con,$_POST['buscar']);
     $query="SELECT * FROM hogar WHERE id_vivienda = '$id_vivienda' and (id_familia LIKE '%$buscar_u%' OR referencia  LIKE '%$buscar_u%') ORDER BY create_at DESC   LIMIT 60"; 
    }    
