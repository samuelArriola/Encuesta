                        ...
                        <div class="row">
                            ...
                            <div  class="input-field col m12 card-panel  s12 ENCUESTA_HOGAR" id="div_eh_exclu_sanitaria">
                              ...
                              <div  class="input-field col m12 card-panel  s12 ENCUESTA_VIVIENDA" id="div_eh_group_lavadero">
                                ...
                                <p>
                                    <label>
                                        <input class="with-gap EC_RES "  id="E2P9_NIN" name="eh_group_lavadero" value="Ninguno" type="radio"  />
                                        <span>Ninguno de los anteriores</span>
                                    </label>
                                </p>
                                <p>
                                    <label>
                                        <input class="with-gap EC_RES" id="E2P9_LMANO" name="eh_group_lavadero" value="Lavamanos" type="radio"  />
                                        <span>Lavamanos</span>
                                    </label>
                                </p>
                                <p>
                                    <label>
                                        <input class="with-gap EC_RES" id="E2P9_LDEO" name="eh_group_lavadero" value="Lavadero" type="radio"  />
                                        <span>Lavadero</span>
                                    </label>
                                </p>
                                <p>
                                    <label>
                                        <input class="with-gap EC_RES" id="E2P9_LPLTO" name="eh_group_lavadero" value="Lavaplatos" type="radio"  />
