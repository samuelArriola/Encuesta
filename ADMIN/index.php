...
<ul id="dropdown_informes" class="dropdown-content">
  <li><a  href="VISTAS/informe_vivienda.php">VIVIENDAS</a></li>
  <li><a  href="VISTAS/informe_hogar.php">HOGARES</a></li>
  <li><a  href="VISTAS/informes.php">INDIVIDUOS</a></li>
</ul>
<nav class="hide-on-med-and-down">  
	<div class="nav-wrapper color-background" style="background-color: white; ">
		<ul class="left hide-on-med-and-down" >
			...
			<li>
				<a class="black-text" id="" style="font-size: 0.8em; text-align: center; height: 64px;" href="VISTAS/create_user.php" >
					<i class="material-icons teal-text " style="height: 16px; line-height: 48px;">supervisor_account</i>Usuarios
				</a>
			</li>
			<li>
				<a class="black-text dropdown-trigger" id="" style="font-size: 0.8em; text-align: center; height: 64px;" data-target="dropdown_informes" >
					<i class="material-icons teal-text " style="height: 16px; line-height: 48px;">assignment</i>Informes
				</a>
			</li>
		</ul>
		<ul class="right hide-on-med-and-down">
...
<li><a class="black-text" id="" style="padding-left: 16px;" href="VISTAS/create_user.php" >
  <i class="material-icons teal-text " style="height: 16px; line-height: 48px;">supervisor_account</i>Usuarios
</a></li>
